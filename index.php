...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logout-link { color: #555; text-decoration: none; font-size: 12px; margin-left: 8px; transition: color 0.2s; }
        .logout-link:hover { color: #ff5050; }
        .hero { padding: 80px 30px 60px; text-align: center; border-bottom: 1px solid #1a1a1a; }
        .hero-eyebrow { font-size: 11px; letter-spacing: 4px; text-transform: uppercase; color: #5b80a8; margin-bottom: 18px; }
        .hero h1 { font-size: 56px; font-weight: 800; letter-spacing: 6px; color: #ffffff; line-height: 1.1; margin-bottom: 18px; }
        ...
        .btn-primary { padding: 11px 28px; background: #5b80a8; color: #fff; text-decoration: none; border-radius: 8px; font-size: 14px; font-weight: 600; letter-spacing: 0.5px; transition: background 0.2s, transform 0.15s; }
        .btn-primary:hover { background: #4a6a90; transform: translateY(-2px); }
        .btn-outline { padding: 11px 28px; background: transparent; color: #fff; text-decoration: none; border-radius: 8px; font-size: 14px; font-weight: 600; border: 2px solid #ffffff; letter-spacing: 0.5px; transition: background 0.2s, transform 0.15s; }
        .btn-outline:hover { background: #1a1a1a; transform: translateY(-2px); }
        .stats-section { display: flex; justify-content: center; gap: 0; border-bottom: 1px solid #1a1a1a; }
        .stat-block { flex: 1; max-width: 240px; padding: 36px 20px; text-align: center; border-right: 1px solid #1a1a1a; }
        .stat-block:last-child { border-right: none; }
        .stat-number { font-size: 40px; font-weight: 800; color: #ffffff; letter-spacing: -1px; line-height: 1; margin-bottom: 8px; }
        ...
        .section-title { font-size: 13px; font-weight: 700; letter-spacing: 3px; text-transform: uppercase; color: #ffffff; border-bottom: 2px solid #5b80a8; padding-bottom: 5px; }
        ...
        .top-genre { font-size: 11px; color: #555; white-space: nowrap; }
...
<nav class="navbar">
    ...
    <div class="nav-right">
        ...
        <div class="user-info">
            <span class="user-badge"><?php echo $_SESSION['user_type']; ?></span>
